...
import { MatriculaCreditosInfoComponent } from './../matricula-creditos-info/matricula-creditos-info.component';
import swal from 'sweetalert';

@Component({
  selector: 'app-matricula-creditos-tramite',
  templateUrl: './matricula-creditos-tramite.component.html',
  styleUrls: ['./matricula-creditos-tramite.component.css'],
  providers: [GeneralService]
})
export class MatriculaCreditosTramiteComponent extends BaseComponent implements OnInit {
  ...
  identificadorNombreTramiteBD = 'Matrícula hasta 26 Créditos';
  idTipoTramite = 0;
  nroTramite;
