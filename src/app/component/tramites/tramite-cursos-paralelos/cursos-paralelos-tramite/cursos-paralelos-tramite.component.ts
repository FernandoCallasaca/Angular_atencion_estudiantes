...
import { CursosParalelosInfoComponent } from './../cursos-paralelos-info/cursos-paralelos-info.component';
import swal from 'sweetalert';
@Component({
  selector: 'app-cursos-paralelos-tramite',
  templateUrl: './cursos-paralelos-tramite.component.html',
  styleUrls: ['./cursos-paralelos-tramite.component.css'],
  providers: [GeneralService]
})
export class CursosParalelosTramiteComponent extends BaseComponent implements OnInit {
  ...
  identificadorNombreTramiteBD = 'Cursos Paralelos';
  idTipoTramite = 0;
  nroTramite;
