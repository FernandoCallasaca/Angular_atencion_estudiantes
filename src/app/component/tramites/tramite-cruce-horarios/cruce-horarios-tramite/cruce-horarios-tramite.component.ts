...
import { CruceHorariosInfoComponent } from './../cruce-horarios-info/cruce-horarios-info.component';
import swal from 'sweetalert';

@Component({
  selector: 'app-cruce-horarios-tramite',
  templateUrl: './cruce-horarios-tramite.component.html',
  styleUrls: ['./cruce-horarios-tramite.component.css'],
  providers: [GeneralService]
})
export class CruceHorariosTramiteComponent extends BaseComponent implements OnInit {
  ...
  identificadorNombreTramiteBD = 'Cruce de Horarios';
  idTipoTramite = 0;
  nroTramite;
